var Y=Object.defineProperty,D=Object.defineProperties;var J=Object.getOwnPropertyDescriptors;var $=Object.getOwnPropertySymbols;var K=Object.prototype.hasOwnProperty,G=Object.prototype.propertyIsEnumerable;var P=(e,t,o)=>t in e?Y(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o,v=(e,t)=>{for(var o in t||(t={}))K.call(t,o)&&P(e,o,t[o]);if($)for(var o of $(t))G.call(t,o)&&P(e,o,t[o]);return e},F=(e,t)=>D(e,J(t));import{s as i,m as b,j as r,a as c,r as l,F as L,J as y,N as x,R as Q,b as V}from"./vendor.3d2bd3db.js";const W=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function o(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerpolicy&&(s.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?s.credentials="include":a.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(a){if(a.ep)return;a.ep=!0;const s=o(a);fetch(a.href,s)}};W();const X=i(b.div)`
...
`,S=i.label`
  ...
  font-weight: 800;
`;function ce(e,t,o){const a=[e,t,o].map(d=>d.replace("#",""));return{labelColor:a[0],messageColor:a[1],logoColor:a[2]}}const de=()=>{const[e,t]=l.exports.useState("#07a0f8"),[o,n]=l.exports.useState("#000000"),[a,s]=l.exports.useState("#ffffff"),{saveColors:d}=M();return l.exports.useEffect(()=>{const m=ce(e,o,a);d(m)},[e,o,a]),r(L,{children:c(ie,{children:[c("div",{className:"center",children:[r(S,{htmlFor:"label-color-select",children:"Label"}),r(y,{color:e,onChange:t}),r(x,{className:"react-colorful-input",id:"label-color-select",color:e,onChange:t})]}),c("div",{className:"center",children:[r(S,{htmlFor:"message-color-select",children:"Message color"}),r(y,{color:o,onChange:n}),r(x,{className:"react-colorful-input",id:"message-color-select",color:o,onChange:n})]}),c("div",{className:"center",children:[r(S,{htmlFor:"techlogo-color-select",children:"Tech logo color"}),r(y,{color:a,onChange:s}),r(x,{className:"react-colorful-input",id:"techlogo-color-select",color:a,onChange:s})]})]})})},ue=i.button`
  min-width: 28rem;
  padding: 1rem 1.5rem;
  display: flex;
  align-items: center;
...
`,k=({children:e,src:t,alt:o,onClick:n})=>c(ue,{onClick:n,children:[e,r(me,{src:t,alt:o})]}),ge=i.section`
  ...
  justify-content: center;
  gap: 2rem;
`;var he="/glass-badgic/assets/markdown.e23a3b3f.svg",fe="/glass-badgic/assets/html.c1156f27.svg",pe="/glass-badgic/assets/link.a1ddaab8.svg";function I(e){try{navigator.clipboard.writeText(e);const t=document.createElement("textarea")}catch(t){console.log(t)}}function ve(e){return e.replaceAll(" ","+")}const be=()=>{const{imageUrl:e}=q(),{imageFields:t}=w(),o=ve(e.imageUrl),n=t.logo,a=`<img src="${o}" alt="${n}"/>`,s=`![${n}](${o})`;return c(ge,{children:[r(k,{src:he,alt:"markdown",onClick:()=>I(s),children:"Copy as Markdown image"}),r(k,{src:fe,alt:"html",onClick:()=>I(a),children:"Copy as HTML image"}),r(k,{src:pe,alt:"url",onClick:()=>I(o),children:"Copy as URL"})]})},ye=i.div`
  display: flex;
  align-items: center;
